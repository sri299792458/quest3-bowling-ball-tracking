...
namespace QuestBowlingStandalone.QuestApp
{
    public static class QuestCaptureMetadataBuilder
    {
        ...
        public static bool TrySnapshotFrameInputs(
            PassthroughCameraAccess cameraAccess,
            Transform headTransform,
            bool allowSystemUtcFallback,
            out long timestampUs,
            out StandaloneTimestampSource timestampSource,
            out Pose cameraPose,
            out Pose headPose)
        {
            timestampUs = 0L;
            timestampSource = StandaloneTimestampSource.Unknown;
            ...
            cameraPose = cameraAccess.GetCameraPose();
            headPose = ResolveHeadPose(headTransform, cameraPose);

            return TryGetFrameTimestampUs(cameraAccess, allowSystemUtcFallback, out timestampUs, out timestampSource);
        }
